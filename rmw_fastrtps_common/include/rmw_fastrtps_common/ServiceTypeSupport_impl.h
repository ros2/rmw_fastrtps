...
#ifndef RMW_FASTRTPS_COMMON__SERVICETYPESUPPORT_IMPL_H_
#define RMW_FASTRTPS_COMMON__SERVICETYPESUPPORT_IMPL_H_
...
#endif  // RMW_FASTRTPS_COMMON__SERVICETYPESUPPORT_IMPL_H_
