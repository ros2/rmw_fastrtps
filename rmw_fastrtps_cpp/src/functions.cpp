...
#include "rmw_fastrtps_cpp/TypeSupport_cpp_impl.h"
...
extern "C"
{
const char * const eprosima_fastrtps_cpp_identifier = "rmw_fastrtps_cpp";

const char *
rmw_get_implementation_identifier()
{
  return eprosima_fastrtps_cpp_identifier;
}
