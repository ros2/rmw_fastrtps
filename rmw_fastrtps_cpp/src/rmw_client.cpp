  ...
  const rmw_qos_profile_t * qos_policies)
{
  ...
  if (!get_datareader_qos(adapted_qos_policies, response_members->type_hash_, reader_qos)) {
  ...
  if (!get_datawriter_qos(adapted_qos_policies, request_members->type_hash_, writer_qos)) {
